 ...
 * named 0 through <em>n</em>&minus;1. The <em>is-connected-to</em> relation
 ...
 * and components are identified with integers between 0 and <em>n</em>&minus;1.
 * Initially, there are <em>n</em> components, with each site in its own
